...
const images = [
...

  {
    ...
    mapUrl:
      "https://www.google.com/maps?q=Gateway+Of+India,Mumbai&output=embed",
  },
  ...
  },
  {
    ...
    caption: "A revered Hindu temple dedicated to Lord Ganesha.",
    src:  new URL("../assets/temple.png", import.meta.url).href,
    id: "ChIJZ8sGQ9fR5zsRj-1iHhL2qWE",
    address: "Siddhivinayak Temple Rd, Prabhadevi, Mumbai, Maharashtra",
    mapUrl:
      "https://www.google.com/maps?q=Siddhivinayak+Temple,Mumbai&output=embed",
  },
  {
    title: "Elephanta Caves",
    caption: "Ancient rock-cut caves with historic sculptures.",
    src: "https://s7ap1.scene7.com/is/image/incredibleindia/elephanta-caves-mumbai-maharashtra-10-musthead-hero?qlt=82&ts=1742180919067",
    id: "ChIJi3tXh9fR5zsR8rYlXHjHn7o",
    address: "Elephanta Island, Mumbai, Maharashtra",
    mapUrl:
      "https://www.google.com/maps?q=Elephanta+Caves,Mumbai&output=embed",
  }
...
const Explore = () => {
  ...
  useEffect(() => {
    ...
    const matchedImage = images.find(
      (img) => img.title.toLowerCase() === place.toLowerCase(),
    )

    if (matchedImage) {
      setSelectedPlaceName(matchedImage.title)
      setMapUrl(matchedImage.mapUrl)
      setApiResults([])
      setSearchTerm('')
      return
    }
    ...
    setMapUrl(`https://www.google.com/maps?q=${encodeURIComponent(`${place}, Mumbai`)}&output=embed`)
    setApiResults([])
    setSearchTerm('')
  }, [searchParams])
    ...
    <div className="min-h-screen bg-[#FFF7ED] py-12 space-y-12">
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-150">
              ...
              {localSuggestions.map((place) => (
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <div
                      onClick={() => selectFromSlider(images.indexOf(place))}
                      className="flex-1"
                    >
          ...
          <div id="map-view" className="lg:col-span-2 relative rounded-4xl shadow-xl overflow-hidden bg-gray-100 border border-gray-200">
            <iframe
              title="Map View"
              width="100%"
              height="100%"
